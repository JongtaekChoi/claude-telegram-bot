...
2026-09-09 에 네 항목의 **로직은 하네스로 덮었다** (`/allow` 38건 · 포럼 접수처 38건 ·
`personas[].dir` 23건). 남은 건 하네스가 대신 못 하는 것 — 텔레그램 왕복과 눈으로 보는 것뿐이다.
...
- [ ] **잃어버린 스위트 복원** — `tests/` 골격은 섰고 0.5.0 이 건드린 곳은 다 덮었다(214건).
